    ...
    class CookiesAllowed
    {
        function __construct()
        {
            ...
            if (defined('ICL_LANGUAGE_CODE') && $this->cookies_allowed_get_default_language() == ICL_LANGUAGE_CODE || !defined('ICL_LANGUAGE_CODE')) {
                add_filter('acf/prepare_field/name=cookies_allowed_default_language_scripts', [$this, 'hide_cookies_allowed_acf_field']);
            }
        }
        ...
        */
        ...
        function get_cookies_allowed_scripts()
        {
            ...
            if (get_field('cookies_allowed_default_language_scripts', 'options')) $this->set_acf_default_language();
            $scripts = [];
            ...
            if (get_field('cookies_allowed_default_language_scripts', 'options')) $this->set_acf_default_language(false);
        ...
        */
        function get_cookies_allowed_html($language_suffix = null)
        {
            ...
            if (get_field('cookies_allowed_default_language_scripts', 'options')) {
                //set the language to site default
                add_filter('acf/settings/current_language', 'cookies_allowed_get_default_language', 100);
            }
            ...
            if (get_field('cookies_allowed_default_language_scripts', 'options')) {
                // reset to original language
                remove_filter('acf/settings/current_language', 'cookies_allowed_get_default_language', 100);
            }
